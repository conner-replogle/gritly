...
>((props, forwardedRef) => {
  ...
  if (!React.isValidElement(children)) {
    log.error("Slot.Pressable - Invalid asChild element", children);
    return null;
  }
...
const View = React.forwardRef<React.ElementRef<typeof RNView>, RNViewProps>(
  (props, forwardedRef) => {
    ...
    if (!React.isValidElement(children)) {
      log.error("Slot.View - Invalid asChild element", children);
      return null;
    }
...
const Text = React.forwardRef<React.ElementRef<typeof RNText>, RNTextProps>(
  (props, forwardedRef) => {
    ...
    if (!React.isValidElement(children)) {
      log.error("Slot.Text - Invalid asChild element", children);
      return null;
    }
...
>((props, forwardedRef) => {
  ...
  if (!React.isValidElement(children)) {
    log.error("Slot.Image - Invalid asChild element", children);
    return null;
  }
